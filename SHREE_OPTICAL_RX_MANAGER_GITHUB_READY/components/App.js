    ...
    <>
      ...
      <div className="panel">
        ...
        <div className="import-grid">
          ...
          <div className="upload"><h4>Load supplied customer master</h4><p>The supplied retailer file contains 100 customer records.</p><button className="primary" onClick={() => save(() => api('customers/seed', { method: 'POST' }), 'Supplied customer master loaded into Neon.')}>Load supplied customers</button></div>
        </div>
        <small>Stored fields: Name + Mobile only.</small>
      </div>
    </>
  );
}
